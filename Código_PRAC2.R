...
titanic <- read.csv("C:/Users/Dany/Downloads/Práctica 2 Limpieza y análisis de datos/Dataset_original/train.csv")
...
write.csv(titanic, "C:/Users/Dany/Downloads/Práctica 2 Limpieza y análisis de datos/titanic.csv")
